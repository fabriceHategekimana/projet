...
silent only
cd ~/Documents/organisation/activités/gestion
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +44 objectifs.md
badd +1 ~/Documents/organisation/activités/gestion/Question.md
argglobal
silent! argdel *
$argadd objectifs.md
edit objectifs.md
...
setlocal tabstop=8
setlocal tagcase=
setlocal tags=./tags,./TAGS,tags,TAGS,~/Documents/organisation/activités/gestion/.tags
setlocal termkey=
setlocal termsize=
...
silent! normal! zE
let s:l = 65 - ((29 * winheight(0) + 18) / 37)
