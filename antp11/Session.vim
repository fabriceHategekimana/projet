...
set shortmess=aoO
badd +0 ex2tp11.m
badd +0 NewtonSolve.m
badd +0 derivee.m
badd +0 ~/note/note_octave
argglobal
silent! argdel *
$argadd ex2tp11.m
edit ex2tp11.m
...
exe '2resize ' . ((&lines * 13 + 8) / 17)
exe 'vert 2resize ' . ((&columns * 74 + 74) / 149)
exe '3resize ' . ((&lines * 1 + 8) / 17)
...
wincmd w
argglobal
if bufexists('NewtonSolve.m') | buffer NewtonSolve.m | else | edit NewtonSolve.m | endif
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <F5> :call RunOctave()
nnoremap <buffer> <F4> :!octave --no-gui
...
wincmd w
argglobal
if bufexists('derivee.m') | buffer derivee.m | else | edit derivee.m | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
