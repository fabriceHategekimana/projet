...
silent only
cd ~/projet/base_de_donnees_projet_de_semestre/code
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 espacePlus.py
badd +1 ../csv/fournisseurss.csv
badd +1 ../csv/livraisons.csv
badd +1 ../csv/flottes.csv
badd +7 ../csv/chantiers.csv
badd +0 ../csv/employes.csv
argglobal
silent! argdel *
$argadd espacePlus.py
edit ../csv/employes.csv
...
wincmd w
argglobal
if bufexists('espacePlus.py') | buffer espacePlus.py | else | edit espacePlus.py | endif
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 211 - ((16 * winheight(0) + 8) / 17)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
211
