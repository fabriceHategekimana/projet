...
silent! normal! zE
let s:l = 90 - ((12 * winheight(0) + 9) / 18)
...
wincmd w
argglobal
if bufexists('../code/espacePlus.py') | buffer ../code/espacePlus.py | else | edit ../code/espacePlus.py | endif
