...
Lorsque le temps devient grand le comportement de l’émetteur tend
vers un comportement stationnaire (ne change pas en probabilité avec
le temps). En effet, soit s(0) n’importe quel vecteur de probabilité,
