...
nnoremap <buffer> éd ^2xt]lxD:s/_/\ /g
...
nnoremap <buffer> ér <Plug>VimwikiRenumberList 
...
silent! normal! zE
let s:l = 13 - ((8 * winheight(0) + 12) / 24)
