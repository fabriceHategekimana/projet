...
set shortmess=aoO
badd +1 ex3tp10.m
badd +6 Euler_Explicite.m
badd +19 Euler_Implicite.m
badd +1 implicite
badd +18 implicite.m
badd +1 Euler_Implicite_charleur.m
badd +18 Euler_Explicite_chaleur.m
badd +1 Ex3b_ref.m
badd +5 Euler_Implicite_chaleur.m
badd +1 .
badd +10 matriceGauche.m
badd +1 ~/note/note_octave
badd +0 getT.m
argglobal
silent! argdel *
$argadd ex3tp10.m
...
exe 'vert 1resize ' . ((&columns * 71 + 74) / 149)
exe '2resize ' . ((&lines * 18 + 19) / 38)
exe 'vert 2resize ' . ((&columns * 77 + 74) / 149)
exe '3resize ' . ((&lines * 17 + 19) / 38)
exe 'vert 3resize ' . ((&columns * 77 + 74) / 149)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
wincmd w
argglobal
if bufexists('Euler_Explicite.m') | buffer Euler_Explicite.m | else | edit Euler_Explicite.m | endif
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <F5> :call RunOctave()
nnoremap <buffer> <F4> :!octave --no-gui
...
wincmd w
argglobal
if bufexists('Euler_Implicite.m') | buffer Euler_Implicite.m | else | edit Euler_Implicite.m | endif
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <F5> :call RunOctave()
nnoremap <buffer> <F4> :!octave --no-gui
