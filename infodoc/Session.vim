...
set shortmess=aoO
badd +0 bibliographie.tex
badd +7 ~/note/note_tex
badd +67 bibliographie.bib
badd +10 ~/.vimrc
argglobal
silent! argdel *
$argadd bibliographie.tex
edit bibliographie.tex
...
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <F5> :execute ":!pdflatex ".bufname("%")." && zathura ".expand('%:r').".pdf" 
nnoremap <buffer> <F2> :call Note("tex")
nnoremap <buffer> éii o\includegraphics[scale=1.2]{image}
nnoremap <buffer> éc i\textsf{}i
nnoremap <buffer> éb i\textbf{}i
nnoremap <buffer> éi i\textit{}i
nnoremap <buffer> éss o\subsection{}i
nnoremap <buffer> és o\section{}i
nnoremap <buffer> éé i\
let &cpo=s:cpo_save
unlet s:cpo_save
setlocal keymap=
setlocal noarabic
