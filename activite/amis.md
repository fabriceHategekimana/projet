...
C'est un principe simple à mettre en place, je suis du genre à donner naturellement sans calculer.
Je dois juste rendre les cadeaux plus personnels et plus équilibrés.

2. Principe de sympathie
C'est un principe très puissant que j'ai complètement oublié.
Le but est de chercher la similarité entre deux personnes.

3. Principe de la non negativity
C'est un principe simple, les fois où je me plain se comptent comme la pluie dans le désert.

4. Complimenter les autres dans mes conversation
Faire des compliment sincères envers la personne. À voir, comment faire un compliment.
...
## Connaître l'autre:
Le principe moves
Chercher a faire ressortir:
1. son mode de vie (habitudes)
2. les observé (faits visuels)
...
Serais-tu plutôt grande ville, petite ville ou campagne? Cette question fait intervenir le vécu et le désir de la personne si celle-ci n'a pas de logement propre ou veut en changer.

Quel est le compliment qui t'a fait le plus plaisir? C'est une question puissante, car elle nous aide à connaître une personne dans ce qui compte beaucoup pour elle.

Quel est ton film/ta série préféré(e)? Permet de savoir les goûts de la personne. Savoir aussi pourquoi cette personne l'apprécie nous rapprochera de ses valeurs.

Aimes-tu parler à des inconnus? Permet de connaître le degré d'ouverture de la personne. Mais je sens que je ne connais pas encore toutes la puissance de cette question.

## Étude de quelque sujets de conversation intéressents:
La beauté:
Qu'est ce qui rends une personne belle selon toi? Cela permet de découvrir les critères et valeurs qu'attribue une personne concernant la beauté.
