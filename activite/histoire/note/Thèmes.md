...
- Traffic
- "Zone de non-droit" = pas de zone de non droit
- Violence urbaine
- Les guetteurs (surveillance)
- Parfois mec de quartier = criminel
- Traffic et minorité
- Et pour les personnes qui veulent vivre normalement?
- La grand borne (ville en France)
- pas les mêmes droits et pas les mêmes opportunités
- désert médical
...
environnement
• Thomas Edison (businessman, inventeur, 1847-1931):
…ce qui fait que cela fonctionne et produit le plus de revenus pour
l’Entereprise
• Alan Turing (mathematicien, informaticien, 1912-1954)
… ce qui rend difficile la distinction entre une tâche réalisée par un être
humain ou par une machine
… (etc, y.c liens avec les emotions)
(Images: Wikipedia)
Stephane.Marchand-Maillet@unige.ch – University of Geneva – Computer Science – AI Intro-23
Un amis en psychologie veut m'a dit que les tests de QI ne sont pas efficace pour mesurer l'intelligence car ces tests sont fait dépendant des critères d'évaluation et de recherche.
