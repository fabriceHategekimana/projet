...
nmap <F12> :!clear
nmap <F9> :so $VIMRUNTIME/syntax/hitest.vim
nmap <F8> :make screenshot
nmap <F7> :!make second
nmap <F6> :call Run2()
nmap <F5> :call Run()
nmap <F4> :call Console()
nmap <F3> :mks!
nmap <F2> :call Note()
nmap <F1> :SyntasticToggleMode
inoremap  []<Left>
inoremap  </><Left>
inoremap  <><Left>
inoremap  :w
...
silent only
cd ~/Documents/organisation/activités/projet
