...
silent only
cd ~/projet/satom/documentation
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +14 note.md
badd +4 ~/projet/satom/documentation/Siren_Federate.md
badd +4 ~/projet/satom/documentation/Elasticsearch_DSL.md
badd +4 ~/projet/satom/documentation/Siren_investigate.md
argglobal
silent! argdel *
$argadd note.md
edit note.md
