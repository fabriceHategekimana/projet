...
Instead of visualizing directly |w|, first apply the transformation m = log(1 + |w|) and do plt.imshow() on m. This trick will come very often when we will investigate the magnitude of complex images. Comment the resulting image.
