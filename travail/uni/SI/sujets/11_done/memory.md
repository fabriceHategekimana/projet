...
Il exécute un programme lourd (optionnellement sur la mémoire RAM) qui écrit des "données sensibles" sur 7 Go de la mémoire du système.
...
Un défaut de page est mineur si la page se trouve en mémoire physique (mémoire rapidement accessible), majeur sinon.
